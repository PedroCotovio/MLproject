...
# Stacked Chart
def make_bar_stack(data, hue = "AdoptionSpeed", x = "AdoptionSpeed", y="prop"):

    props = data.groupby(data[hue])[x].value_counts(normalize=True).unstack()
    props.plot(kind='bar', stacked='False', figsize=(15, 6)).margins(0)
